...
use App\Filament\Resources\Aspirations\Pages\ViewAspiration;
use App\Filament\Resources\Aspirations\Schemas\AspirationForm;
use App\Filament\Resources\Aspirations\Schemas\AspirationInfolist;
...
class AspirationResource extends Resource
{
    ...
    {
        return AspirationInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewAspiration::route('/{record}'),
